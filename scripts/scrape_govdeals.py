...
def scrape_page(page, url):
    ...
    if not cards:
        # Nothing matched. Save the page HTML so we can inspect it and fix selectors.
        with open("debug_page.html", "w") as f:
            f.write(page.content())
        print("No cards found with any selector. Saved debug_page.html for inspection.", file=sys.stderr)
        return listings
